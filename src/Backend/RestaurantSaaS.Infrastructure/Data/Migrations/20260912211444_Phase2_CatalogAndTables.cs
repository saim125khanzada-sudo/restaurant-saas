...
{
    /// <inheritdoc />
    public partial class Phase2_CatalogAndTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_floor_sections", x => x.Id);
                    table.ForeignKey(
                        name: "FK_floor_sections_branches_BranchId",
                        column: x => x.BranchId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TaxRatePercentage = table.Column<decimal>(type: "numeric", nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<string>(type: "text", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    UpdatedBy = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RestaurantId = table.Column<Guid>(type: "uuid", nullable: false),
                    BranchId = table.Column<Guid>(type: "uuid", nullable: true),
                    FloorSectionId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_restaurant_tables_floor_sections_FloorSectionId",
                        column: x => x.FloorSectionId,
                        principalTable: "floor_sections",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_product_addons_addons_AddonId",
                        column: x => x.AddonId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_floor_sections_BranchId",
                table: "floor_sections",
                column: "BranchId");

            migrationBuilder.CreateIndex(
                name: "IX_product_addons_AddonId",
                table: "product_addons",
                column: "AddonId");

            migrationBuilder.CreateIndex(
                name: "IX_product_addons_ProductId_AddonId",
                table: "product_addons",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_products_RestaurantId_CategoryId_IsAvailable",
                table: "products",
                columns: new[] { "RestaurantId", "CategoryId", "IsAvailable" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_restaurant_tables_FloorSectionId",
                table: "restaurant_tables",
                column: "FloorSectionId");
